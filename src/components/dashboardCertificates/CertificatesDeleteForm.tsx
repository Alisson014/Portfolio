...
type SkillsAddDeleteType = {
    ...
    data: Array<CertificatesType>,
}

export default function CetificatesDeleteForm( { setIsUpdating, data } : SkillsAddDeleteType ){
    ...
    return(
        <div className="w-full bg-black border border-gray-700 rounded-lg p-4 appearAnimation">
            ...
            <ModalDeleteCertificate ids={items} setItems={setItems} isVisible={isVisible} setIsVisible={setIsVisible} setIsUpdating={setIsUpdating} />
        </div>
    );
}