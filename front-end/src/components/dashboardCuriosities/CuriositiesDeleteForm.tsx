...
import ModalDeleteCuriosities from "./ModalDeleteCuriosities";
...
type SkillsAddDeleteType = {
    ...
    data: Array<CuriositiesType>,
}

export default function CuriositiesDeleteForm( { setIsUpdating, data } : SkillsAddDeleteType ){
    ...
    return(
        <div className="w-full bg-black border border-gray-700 rounded-lg p-4 appearAnimation">
            <header className="flex items-center gap-2">
                ...
                <h1 className="text-lg sm:text-2xl font-semibold">Deletar Skill</h1>
            </header>
            ...
            <ModalDeleteCuriosities ids={items} setItems={setItems} isVisible={isVisible} setIsVisible={setIsVisible} setIsUpdating={setIsUpdating} />
        </div>
    );
}