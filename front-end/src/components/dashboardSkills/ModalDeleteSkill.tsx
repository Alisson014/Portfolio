...
export default function ModalDeleteSkill({ setIsVisible, isVisible, ids, setIsUpdating, setItems } : ModalDeleteSkillType){
    ...
    return(
        ...
        >
            <div onClick={(e) => e.stopPropagation()} className={`flex flex-col justify-center items-center w-75 p-4 bg-gray-900 rounded-2xl overflow-hidden`}>
                ...
                <h1 className="text-xl font-semibold">Deletar Skill?</h1>
