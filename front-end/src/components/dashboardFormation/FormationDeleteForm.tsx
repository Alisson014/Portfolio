...
import ModalDeleteFormation from "./ModalDeleteFormation";
...
type SkillsAddDeleteType = {
    ...
    data: Array<FormationType>,
}

export default function FormationDeleteForm( { setIsUpdating, data } : SkillsAddDeleteType ){
    ...
    return(
        <div className="w-full bg-black border border-gray-700 rounded-lg p-4 appearAnimation">
            ...
            <ModalDeleteFormation ids={items} setItems={setItems} isVisible={isVisible} setIsVisible={setIsVisible} setIsUpdating={setIsUpdating} />
        </div>
    );
}